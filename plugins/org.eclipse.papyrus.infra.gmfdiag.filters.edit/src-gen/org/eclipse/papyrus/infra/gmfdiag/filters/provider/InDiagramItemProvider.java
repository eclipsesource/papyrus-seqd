 ...
 * @generated
 */
public class InDiagramItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	/**
	...
	protected void addFilterPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_InDiagram_filter_feature"), //$NON-NLS-1$
	...
	/**
	 * This returns InDiagram.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	...
	protected Command createSetCommand(EditingDomain domain, EObject owner, EStructuralFeature feature,
		...
		if (feature == DiagramFiltersPackage.Literals.IN_DIAGRAM__OWNED_FILTER) {
			return new SubsetSupersetSetCommand(domain, owner, feature,
					new EStructuralFeature[] {DiagramFiltersPackage.Literals.IN_DIAGRAM__FILTER }, null,
					value);
		}
		if (feature == DiagramFiltersPackage.Literals.IN_DIAGRAM__FILTER) {
			return new SubsetSupersetSetCommand(domain, owner, feature, null,
					new EStructuralFeature[] {DiagramFiltersPackage.Literals.IN_DIAGRAM__OWNED_FILTER },
					value);
		}
