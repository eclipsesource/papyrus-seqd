...
public class UMLDiagramActionBarContributor extends DiagramActionBarContributor {
	...
	@Override
	protected Class<LightweightSequenceDiagramEditor> getEditorClass() {
		return LightweightSequenceDiagramEditor.class;
	}
	...
	protected String getEditorId() {
		return LightweightSequenceDiagramEditor.ID;
	}
