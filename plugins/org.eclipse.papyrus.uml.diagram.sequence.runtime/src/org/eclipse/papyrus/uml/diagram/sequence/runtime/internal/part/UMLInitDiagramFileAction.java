...
public class UMLInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		try {
			...
			Activator.log.error("Unable to load resource: " + domainModelURI, ex); //$NON-NLS-1$
		}
		if (diagramRoot == null) {
		...
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle, RepresentationKind.MODEL_ID));
