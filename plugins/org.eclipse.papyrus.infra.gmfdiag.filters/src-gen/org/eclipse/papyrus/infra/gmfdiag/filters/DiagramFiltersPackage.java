...
public interface DiagramFiltersPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link org.eclipse.papyrus.infra.gmfdiag.filters.impl.InDiagramImpl <em>In
	...
	/**
	 * The feature id for the '<em><b>Filter</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @generated
	 * @ordered
	...
	/**
	 * The feature id for the '<em><b>Owned Filter</b></em>' containment reference. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	...
	/**
	 * The number of structural features of the '<em>In Diagram</em>' class. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	...
	/**
	 * The operation id for the '<em>Matches</em>' operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The number of operations of the '<em>In Diagram</em>' class. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @generated
	 * @ordered
	...
	/**
	 * The meta object id for the '{@link org.eclipse.papyrus.infra.gmfdiag.filters.impl.ViewTypeImpl <em>View
	...
	/**
	 * The number of structural features of the '<em>View Type</em>' class. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	...
	/**
	 * The number of operations of the '<em>View Type</em>' class. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @generated
	 * @ordered
	...
	/**
	 * Returns the meta object for class '{@link org.eclipse.papyrus.infra.gmfdiag.filters.InDiagram <em>In
	 ...
	 * '{@link org.eclipse.papyrus.infra.gmfdiag.filters.InDiagram#getFilter <em>Filter</em>}'. <!--
	 ...
	 * '{@link org.eclipse.papyrus.infra.gmfdiag.filters.InDiagram#getOwnedFilter <em>Owned Filter</em>}'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the meta object for class '{@link org.eclipse.papyrus.infra.gmfdiag.filters.ViewType <em>View
	 ...
	 * '{@link org.eclipse.papyrus.infra.gmfdiag.filters.ViewType#getType <em>Type</em>}'. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	interface Literals {
		 ...
		 * '{@link org.eclipse.papyrus.infra.gmfdiag.filters.impl.InDiagramImpl <em>In Diagram</em>}' class.
		 * <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @see org.eclipse.papyrus.infra.gmfdiag.filters.impl.InDiagramImpl
		 * @see org.eclipse.papyrus.infra.gmfdiag.filters.impl.DiagramFiltersPackageImpl#getInDiagram()
		...
		/**
		 * The meta object literal for the '<em><b>Filter</b></em>' reference feature. <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		...
		/**
		 * The meta object literal for the '{@link org.eclipse.papyrus.infra.gmfdiag.filters.impl.ViewTypeImpl
		 * <em>View Type</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @see org.eclipse.papyrus.infra.gmfdiag.filters.impl.ViewTypeImpl
		 * @see org.eclipse.papyrus.infra.gmfdiag.filters.impl.DiagramFiltersPackageImpl#getViewType()
		 * @generated
