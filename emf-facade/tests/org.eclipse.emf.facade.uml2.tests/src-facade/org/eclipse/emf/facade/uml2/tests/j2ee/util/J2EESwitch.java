...
public class J2EESwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case J2EEPackage.PACKAGE: {
				org.eclipse.emf.facade.uml2.tests.j2ee.Package package_ = (org.eclipse.emf.facade.uml2.tests.j2ee.Package)theEObject;
	 ...
	 * @generated
	 */
	public T casePackage(org.eclipse.emf.facade.uml2.tests.j2ee.Package object) {
		return null;
	}
